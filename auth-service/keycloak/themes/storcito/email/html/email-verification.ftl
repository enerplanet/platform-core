...
<head>
    ...
    <title>Verify Your Email - Storcito</title>
    <!--[if mso]>
    <style type="text/css">
                                ...
                                <tr>
                                    <td style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 12px; padding: 20px 24px;">
                                        <p style="margin: 0; font-size: 15px; color: #374151; line-height: 1.6;">
                                            Your Storcito account has been created. Please verify your email address to activate your account and start using our energy simulation platform.
                                        </p>
                                    </td>
                                </tr>
                            </table>
