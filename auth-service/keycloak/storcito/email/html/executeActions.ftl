...
<head>
    ...
    <title>Password Reset - EnerPlanET</title>
    <!--[if mso]>
    <style type="text/css">
                    ...
                    <tr>
                        <td style="padding: 44px 36px 20px;">
                            ...
                            <p style="margin: 0 0 20px; font-size: 15px; color: #374151; line-height: 1.6;">
                                We received a request to reset your password for your EnerPlanET account. If you didn't make this request, you can safely ignore this email.
                            </p>
                    ...
                    <tr>
                        <td style="padding: 20px 0; text-align: center;">
                            <p style="margin: 0; font-size: 12px; color: #9ca3af; line-height: 1.5;">
                                This is an automated message from EnerPlanET. Please do not reply to this email.
                            </p>
                        </td>
                    </tr>
                </table>
